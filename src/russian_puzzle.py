...
serialized_stack = [(0,0,0)]*len(pieces)
...
def recursive_search(board, pieces, depth):
    if depth == len(pieces):
        ...
        solution_counter += 1
        print(f'Solutions: {solution_counter}, time: {dt}, ({solution_counter / dt} sol/sec)')
        pprint(board)
        return
...
print(board)
print(pieces)
recursive_search(board, pieces, 0)

#print(flood_fill_from(board, 0, 0))
#print(in_losing_state(board))
